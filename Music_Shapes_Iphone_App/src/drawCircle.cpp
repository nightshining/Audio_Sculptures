...
//--------------------------------------------------------------
void drawCircle::mouseDragged(int x, int y, int button){
    
  
}

//--------------------------------------------------------------
void drawCircle::mousePressed(int x, int y, int button){
...
//--------------------------------------------------------------
void drawCircle::mouseReleased(int x, int y, int button){
