...
void drawCube::setup(){    
    ...
    triggerSound = false;
    cubeSound.loadSound("drawCubeSound.aif");   
...
//--------------------------------------------------------------
void drawCube::keyPressed(int key){
...
//--------------------------------------------------------------
void drawCube::mouseDragged(int x, int y, int button){
    
}

//--------------------------------------------------------------
void drawCube::mousePressed(int x, int y, int button){
