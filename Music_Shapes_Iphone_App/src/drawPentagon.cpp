...
//--------------------------------------------------------------
void drawPentagon::mouseDragged(int x, int y, int button){
...
//--------------------------------------------------------------
void drawPentagon::mousePressed(int x, int y, int button){
    
}

//--------------------------------------------------------------
void drawPentagon::mouseReleased(int x, int y, int button){
